...
def review_wrong_answers(wrong_answers):
   ...
   #If the user pressed enter or a letter it will count it as invailed and will count as wrong for the "You answered ___..."
   #When asking the user if they want to review the questions they got wrong, it counts as correct?!
